function MusicPage() {
    return <section className="hobbies-sub-page" id="music-page" tabIndex={0}>
        ...
        <p className="hobby-page-text">You can view a list of every album I've ever listened to on my <a href="https://musicboard.app/edthuman/albums" target="blank" className="page-link">profile</a>. In 2023, I listened to 600 new albums!</p>
