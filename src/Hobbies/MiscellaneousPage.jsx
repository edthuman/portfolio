...
function MiscellaneousPage() {
    return <section className="hobbies-sub-page" tabIndex={0}>
        ...
        <section id="miscellaneous-text-area">
            ...
            <p className="miscellaneous-page-text">I do play the occassional video game. My favourite series are The Last of Us, Red Dead Redemption, and Jak and Daxter.</p>
