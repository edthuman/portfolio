...
function Contacts() {
    return <section className="page" id="contacts-page">
        <h2 id="contacts-heading">Still want to know more?</h2>
        <p className="contacts-subheading">Feel free to get out my <a href="https://github.com/edthuman" target="blank" className="contacts-page-link">GitHub</a></p>
